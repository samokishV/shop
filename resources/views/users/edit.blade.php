        ...
        <div class="col-sm">
            <form action="" class="checkout" method="post" id="user-add">
                ...
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="{{old('email', $user->email)}}" class="form-control" required id="email">
                    @if ($errors->has('email'))
                ...
                <div class="form-group">
                    ...
                    <input type="password" name="password" value="{{old('password', $user->password)}}" class="form-control" required id="password">
                ...
                <div class="form-group">
                    ...
                    <select name="role" id="role">
                        ...
                        <option value="guest" @if(old('role', $user->role)=="guest") selected @endif>Guest</option>
                    </select>
                    @if ($errors->has('role'))
                        <div class="alert alert-danger">
                            {{ $errors->first('role') }}
